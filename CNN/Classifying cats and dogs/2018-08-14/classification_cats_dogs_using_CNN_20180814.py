...
test_set = test_datagen.flow_from_directory('/home/abhiyush/mPercept/Computer vision /Covolution Neural Network (CNN)/Classifying cats and dogs /dataset/test_set',
                                            target_size = (128, 128),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
a = 0    
if dog in result_cats:
    a = a +1

for dog in result_cats:
    if "Dog" in dog:
        a = a + 1
214/1000
