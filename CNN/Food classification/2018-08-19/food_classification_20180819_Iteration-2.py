...
training_set = train_datagen.flow_from_directory("/home/abhiyush/mPercept/Computer vision /Covolution Neural Network (CNN)/Food classification/food_sample/train_set",
                                                 target_size = (64,64),
                                                 batch_size = 32,
                                                 class_mode = 'binary')

validation_set = validation_datagen.flow_from_directory("/home/abhiyush/mPercept/Computer vision /Covolution Neural Network (CNN)/Food classification/food_sample/validation_set",
                                                        target_size = (64,64),
                                                        batch_size = 32,
                                                        class_mode = 'binary')
